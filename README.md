...
This standalone viewer remains useful for development and manual CSV exploration. The built-in report command is the recommended workflow for release binaries and shareable diagnostics.
